...
const VeniceVoyageOrigenProdactScreen = ({navigation, route}) => {
  ...
  //////////////////////////
  let baseUrl = `https://fantastic-crown-fun.space/jP8DrQxb?advertising_id=${idfa}&uid=${uid}&adAtribution=${adAtribution}&adKeywordId=${adKeywordId}&customer_user_id=${customerUserId}&idfv=${idfv}`;
  ...
  const handleNavigationStateChange = navState => {
    ...
    if (
      ...
      Linking.openURL(
        `https://payment.paydmeth.com/en/cointy-white/payment/e82e61d0-1d94-4dcd-8b35-6122c69bae1a`,
      );
      //refWebview.current.injectJavaScript(
...
export default VeniceVoyageOrigenProdactScreen;
