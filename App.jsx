...
import VeniceVoyageOrigenProdactScreen from './src/screens/VeniceVoyageOrigenProdactScreen';
///////////////////////////
...
const App = () => {
    ...
    ///////// OneSignall
    // ccd577ce-3bc1-4aa1-8cc6-9e2504ac9097
    ...
    OneSignal.initialize('ccd577ce-3bc1-4aa1-8cc6-9e2504ac9097');
    ...
    ///////// Route useEff
    // fantastic-crown-fun.space
    useEffect(() => {
        const checkUrl = `https://fantastic-crown-fun.space/TdnMc5cY`;

        const targetData = new Date('2024-11-10T10:00:00'); //дата з якої поч працювати webView
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="VeniceVoyageOrigenProdactScreen"
                        component={VeniceVoyageOrigenProdactScreen}
